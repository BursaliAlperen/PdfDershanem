/*
  ...
  Default config is the placeholder; pass the real config to initRealtime or store it in localStorage
  under key "pdf_dershanem_rtdb_cfg" to auto-init via autoInitIfConfigured().
*/

const DEFAULT_RTDB_CONFIG = {
  // Example placeholder; replace or pass your real config to initRealtime
  apiKey: "<API_KEY>",
